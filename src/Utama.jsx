...
function Utama(){
    return(
        <div className="relative pt-12 sm:pt-44 flex flex-col items-center text-center p-6 md:p-12 bg-gray-50 sm:bg-none">
...
<section id="home" className="h-screen flex flex-col items-center justify-center text-center -mt-28">
        ...
        <button onClick={() => window.open('https://shopee.co.id/naufalstone7', '_blank')} className="font-quattrocentro bg-amber-800 text-white px-6 py-2 rounded-md hover:bg-amber-900 transition duration-300 z-0">
          Pesan Sekarang
        </button>
      </section>

      {/* Profil Usaha */}
      <section id="profil" className=" min-w-90 mt-5 py-3">
        <ProfilUsaha />
      </section>

      {/* Carousel Section */}
      <section id="koleksi" className="min-w-full">
