...
function Carousel() {
  ...
  const carouselItems = [
    ...
    { id: 4, src: "Batu4.jpg", alt: "Slide 4" },
    { id: 5, src: "Batu5.jpg", alt: "Slide 5" },
    { id: 6, src: "Batu6.jpg", alt: "Slide 6" },
  ];
  ...
  return (
    <div className="w-full flex justify-center items-center mt-6 relative">
      {/* Wrapper Carousel */}
      <div className="max-w-96 sm:min-w-full bg-white rounded-lg shadow-lg overflow-hidden relative p-4">
        ...
        <div className="mt-6 flex justify-center">
          <button
            onClick={() =>
              window.open("https://shopee.co.id/naufalstone7#product_list", "_blank")
            }
